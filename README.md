...
[最新更新](#最新更新) • [功能特性](#功能特性) • [快速开始](#快速开始) • [使用指南](#使用指南) • [配置说明](#配置说明) • [常见问题](#常见问题)
...
- Pandy AI 打标器 V1.0 首次正式发布，满足了初步标注的痛点- 2025.01.02

**🎊 首次正式发布**

这是 Pandy AI 打标器的首个正式版本，为 LoRA 和 Stable Diffusion 训练者带来全新的打标体验！
...
- ✅ 标签页独立设计，快速模式切换
- ✅ 支持多个 AI 提供商（SiliconFlow、ModelScope、Tuzi）
- ✅ 灵活的提示词模板系统
- ✅ 本地化 Web 界面，浏览器即用
- ✅ 批量处理能力，支持数百张图片
- ✅ 多格式支持（JPG、PNG、WEBP）
